function startAStarSearch(s_node, e_node, n_map){
    var aStar = {
        findPath: function(start,end,rows,cols,grid)
        {
            ...
            var node_loop = setInterval(function(){
                ...
                var neighbors=aStar.neighbors(grid,currentNode,rows,cols);
    ...
    {
        var d1=Math.abs(node1[0]-node2[0]);
        var d2=Math.abs(node1[1]-node2[1]);
        return d1+d2;
    },   
    ...
    function aStarSearch(row_count,col_count,startCoordinates,goalCoordinates,obstacleList)
    {
        var rows=row_count;
        ...
        var finalpath=aStar.findPath([s_node[1], s_node[0]],[e_node[1], e_node[0]],rows,cols,grid);
        return finalpath;
    }
    ...
    var finalpath = aStarSearch(row_grid, col_grid, [s_node[1], s_node[0]], [e_node[1], e_node[0]],obstacles);
    //printing the path
